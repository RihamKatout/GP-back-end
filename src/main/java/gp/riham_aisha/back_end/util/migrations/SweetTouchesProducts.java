...
public class SweetTouchesProducts {
    ...
    private ConfigurationAttributes getCakeAttribute(int i) {
        if (i == 0)
            return new ConfigurationAttributes(null, "Color", AttributeType.COLOR, List.of(new Choice("#AB0624", 0.0), new Choice("#7092BE", 0.0), new Choice("#8E403A", 0.0) , new Choice("#FFC0CB", 0.0)), null);
        else if (i == 1)
            return new ConfigurationAttributes(null, "Flavor", AttributeType.OTHER, List.of(new Choice("Frosting", 2.0), new Choice("Fruit", 1.0), new Choice("Nuts", 12.0), new Choice("Chocolate", 2.5) ,new Choice("Nothing", 0.0)), null);
        else if (i == 2)
        return new ConfigurationAttributes(null, "Cake size", AttributeType.SIZE, List.of(new Choice("S", 0.0), new Choice("M", 4.0), new Choice("L", 7.0)), null);
            ...
            return new ConfigurationAttributes(null, "Cake Shape", AttributeType.OTHER,
                    List.of(
                            new Choice("Round", 0.0), new Choice("Heart", 1.0), new Choice("Square", 1.5)
                    ), null);
        if (i == 4)
            return new ConfigurationAttributes(null, "Layers", AttributeType.OTHER,
                    List.of(
                            new Choice("2 Layer", 0.0), new Choice("3 Layers", 5.0), new Choice("4 Layers", 10.0)
                    ), null);

            return new ConfigurationAttributes(null, "Filling", AttributeType.OTHER, List.of(new Choice("Cramel", 0.0), new Choice("Chocolate", 0.0), new Choice("Blueberry", 0.0) , new Choice("Strawberry", 0.0)), null);
    ...
    private ProductConfiguration getCakeConfiguration(int i) {
        if (i == 0)
            ...
            return new ProductConfiguration(null, "Filling", false, 0.0, null, List.of(getCakeAttribute(5)));
        else if (i == 2)
        return new ProductConfiguration(null, "Size", false, 0.0, null, List.of(getCakeAttribute(2)));
        else if (i == 3)
            return new ProductConfiguration(null, "Shape", false, 0.0, null, List.of(getCakeAttribute(3)));

        return new ProductConfiguration(null, "Layers", false, 0.0, null, List.of(getCakeAttribute(4)));

    }

    private void cake() {
        // 3d cake
        Product customizableCake = new Product(null, "3d Model cake", "Delicious cake, you can design it, choose topping and filling as you want!", "https://drive.google.com/thumbnail?id=1TNNsDa0VtvuowOaCOnRBTsyoy1ZBavDb", 15.0, 0, 0, false, true, "https://drive.google.com/thumbnail?id=1TNNsDa0VtvuowOaCOnRBTsyoy1ZBavDb", true, false, null, 0, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customizableCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2) , getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        Product customizable3DCake = new Product(null, "3d Model cake", "Delicious cake, you can design it, choose topping and filling as you want!", "https://drive.google.com/thumbnail?id=1WiIx3o3Kc7ERr0D53sbnkYgT953fYtw7", 15.0, 0, 0, false, true, "https://drive.google.com/thumbnail?id=1TNNsDa0VtvuowOaCOnRBTsyoy1ZBavDb", true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customizable3DCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        Product customizable3DHeart = new Product(null, "3d Model Heart cake", "Delicious cake, you can design it, choose topping and filling as you want!", "https://drive.google.com/thumbnail?id=1-p4utPeNapqZm_8vxcrMaYrACJnnajS-", 15.0, 0, 0, false, true, "https://drive.google.com/thumbnail?id=1TNNsDa0VtvuowOaCOnRBTsyoy1ZBavDb", true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customizable3DHeart, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        Product customizable3DCharry = new Product(null, "3d Model Charry cake", "Delicious cake, you can design it, choose topping and filling as you want!", "https://drive.google.com/thumbnail?id=1JnuBT09LJixwBlsgvlYxD5yIFyUgRH65", 15.0, 0, 0, false, true, "https://drive.google.com/thumbnail?id=1TNNsDa0VtvuowOaCOnRBTsyoy1ZBavDb", true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customizable3DCharry, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Caramel Cake
        Product caramelCake = new Product(null, "Caramel Cake", "Delicious caramel cake, customizable with toppings and fillings of your choice!", "https://drive.google.com/thumbnail?id=1wQUTz2ePmjsXlTsfAitl95e201v4_ZUs", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(caramelCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Chocolate Cake
        Product chocolateCake = new Product(null, "Chocolate Cake", "Delicious chocolate cake, customizable with toppings and fillings of your choice!", "https://drive.google.com/thumbnail?id=1ifr8sYbwVXtpVDLw6d2FLHgKaisvBCR_", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(chocolateCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Vanilla Cake
        Product vanillaCake = new Product(null, "Vanilla Cake", "Delicious vanilla cake, customizable with toppings and fillings of your choice!", "https://drive.google.com/thumbnail?id=1e86D7GYG83cKD8V4TvCsZjhsg3aXHksM", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(vanillaCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Strawberry Cake
        Product strawberryCake = new Product(null, "Strawberry Cake", "Delicious strawberry cake, customizable with toppings and fillings of your choice!", "https://drive.google.com/thumbnail?id=1WwNh_nY9vKiLl7gJIfoijEpO3WbHaCHN", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(strawberryCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Blueberry Cake
        Product blueberryCake = new Product(null, "Blueberry Cake", "Delicious blueberry cake, customizable with toppings and fillings of your choice!", "https://drive.google.com/thumbnail?id=1rlLWbEAKAgguWR1ipYdNxNPu1z6F3zqG", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(blueberryCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Custom strawberry cake
        Product customStrawberryCake = new Product(null, "Custom Strawberry Cake", "A delicious strawberry cake that you can fully customize! Choose your toppings, fillings, and size to make it your own.", "https://drive.google.com/thumbnail?id=1ZULduXcVOXpfnU0Fc6m6ZgwMArwhQzJo", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customStrawberryCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Custom cherry cake
        Product customCherryCake = new Product(null, "Custom Cherry Cake", "A delightful cherry cake that you can fully customize! Choose your toppings, fillings, and size to create your perfect dessert.", "https://drive.google.com/thumbnail?id=1OtZweS2S7qufl5l9839_x2K2UkWGFGE_", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customCherryCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));

        // Custom lemon cake
        Product customLemonCake = new Product(null, "Custom Lemon Cake", "A zesty and refreshing lemon cake that you can fully customize! Add your favorite toppings, fillings, and choose the perfect size.", "https://drive.google.com/thumbnail?id=14o3N0M5mhhavcbRGNYmTn2O0rOE5t3_S", 10.0, 0, 0, false, true, null, true, false, null, 0, null, null, null, null, null);
        productService.addProduct(new ProductManagementDto(customLemonCake, 3L, List.of(getCakeConfiguration(0), getCakeConfiguration(1), getCakeConfiguration(2), getCakeConfiguration(3) , getCakeConfiguration(4)), 1L));
    }
    ...
    private void cookies() {
        // classic cookies
        Product customCookies = new Product(null, "Custom Cookies", "Delicious cookies made just the way you like them! Customize with your favorite flavors, toppings, and sizes.", "https://drive.google.com/thumbnail?id=1HNXDbz6bDqkyBR-WBKN-87gV00wiL0gS", 5.0, 0, 0, false, true, null, false, false, null, 0, null, null, null, null, null);
        ...
        //Dark Cookies
        Product darkCookies = new Product(null, "Dark Cookies", "Rich and decadent dark cookies with customizable flavors, toppings, and sizes to match your cravings.", "https://drive.google.com/thumbnail?id=1oKsdMLu-NII0fL8VCB_KiXaBRPB7PNUI", 6.0, 0, 0, false, true, null, false, false, null, 0, null, null, null, null, null);
